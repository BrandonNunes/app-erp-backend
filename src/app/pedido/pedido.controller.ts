...
export class PedidoController {
  ...
  async create(@Res() response: Response, @Body() createPedidoDto: CreatePedidoDto) {
    try {
      ...
      //   tempTableForListPedido.rows.add(...Object.values(createPedidoDto.listItem[index]))
      // });
      ...
      //   tempTableForListPedido.rows.add(...Object.values(createPedidoDto.listItemAtributo[index]))
      // });
      //
